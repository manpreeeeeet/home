---
title: rss-reader
description: "I like reading blogs but I don't enjoy using rss readers or having a separate app. I mostly find new blog posts from social media or hackernews.
This means I might miss out on posts from blogs I like. So I have built my own chronological feed by consuming rss feed of my favorite blogs."
---
...
## \#\# Problem
I like reading blogs but I don't enjoy using `rss readers` or having a separate app. I mostly find new blog posts from social media or hackernews.
This means I might miss out on posts from blogs I like. So I have built my own chronological feed by consuming `rss` feed of my favorite blogs. You can find it
[here](/blogs).
...
## \#\# Script
The script requires you install the following packages:
```
click==8.1.7
feedparser==6.0.11
joblib==1.4.2
